...
class NumberLifeMid(Range):
    """Number of life the randomizer expect you to have before facing Alice and the Prismiriver sister"""
    display_name = "Number of life expected in order to face Alice and the Prismiriver sister"
    range_start = 0
    range_end = 8
    default = 3

class NumberBombsMid(Range):
    """Number of bombs the randomizer expect you to have before facing Alice and the Prismiriver sister"""
    display_name = "Number of bombs expected in order to face Alice and the Prismiriver sister"
    range_start = 0
    range_end = 8
    default = 2

class DifficultyMid(Choice):
    """The difficulty expected in order to face Alice and the Prismiriver sister (Starting from Lunatic and got to Easy)"""
    display_name = "Difficulty in order to face Alice and the Prismiriver sister"
    option_lunatic = 0
    option_hard = 1
    option_normal = 2
    option_easy = 3
