...
def after_set_rules(world: World, multiworld: MultiWorld, player: int):
    ...
    for region in multiworld.get_regions(player):
        match region.name:
            case "Reimu-Mid-Game" | "Marisa-Mid-Game" | "Sanae-Mid-Game" | "Sakuya-Mid-Game" | "Shop-Mid-Game" :
            ...
            case "Reimu-End-Game" | "Marisa-End-Game" | "Sanae-End-Game" | "Sakuya-End-Game" | "Shop-End-Game":
                for entrance in region.entrances:
                    old_rule = entrance.access_rule
    ...
    ending = multiworld.get_location("__Manual Game Complete__", player)
